...
* contract
*
* The PriceFeed uses Chainlink as primary oracle, and previos stored price as a fallback.
*/
contract PriceFeedChainLink is Ownable, CheckContract, BaseMath, IPriceFeed {
    ...
    */
        ...
        onlyOwner
    {
        ...
        require(_tellorCallerAddress == address(0), "PriceFeed: TellorCaller not supported");
    ...
    *
    * Uses a main oracle (Chainlink). If chainlink fails, 
